...
const todo = (function () {
  ...
  tasks = [
    Todo(["jared", "w", (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), 5)]),
    Todo(["kenny", "w", new Date()]),
    Todo(["alpha", "w", (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), 10)]),
  ];
